...
const TEXTS = {
    ja: {
        ...
        storageWarning: "注意: 写真はこの端末のブラウザにのみ保存されます。キャッシュをクリアすると消えます。"
    },
    en: {
        ...
        storageWarning: "Note: Photos are stored locally in this browser. Clearing data will remove them."
    }
};
...
function initDashboardPage() {
    ...
    elements.uploadInput.addEventListener('change', async function (e) {
        ...
        try {
            // Compress Image
            const compressedBase64 = await compressImage(file, 800, 0.6); // Max 800px width, 0.6 quality
